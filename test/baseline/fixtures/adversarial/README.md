...
| `create-schema-public.sql`            | R8                                                        | Dropped: line 26, `CREATE SCHEMA public;`. The rest is kept, including `COMMENT ON SCHEMA public IS 'standard public schema';` (line 33).                                                                                                                                                                                                 |
