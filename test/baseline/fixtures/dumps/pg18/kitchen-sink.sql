...
\restrict JNPSzHXajxYVHwHbj39fr9ml3xAUJREn8iHPEC5m4mQezM8Zp4ia5cFbUDDTbJe
...
CREATE TABLE kitchen.measurements_2025 (
    sensor_id integer CONSTRAINT measurements_sensor_id_not_null NOT NULL,
    measured_at timestamp with time zone CONSTRAINT measurements_measured_at_not_null NOT NULL,
    value double precision
);
...
CREATE TABLE kitchen.orders_by_region_eu (
    region text CONSTRAINT orders_by_region_region_not_null NOT NULL,
    order_id bigint CONSTRAINT orders_by_region_order_id_not_null NOT NULL,
    placed_on date DEFAULT CURRENT_DATE CONSTRAINT orders_by_region_placed_on_not_null NOT NULL
)
...
--
-- Name: pg18_parcels; Type: TABLE; Schema: kitchen; Owner: -
--
...
CREATE TABLE kitchen.pg18_parcels (
    ...
    area_cm2 numeric GENERATED ALWAYS AS ((width_cm * height_cm))
);


--
-- Name: COLUMN pg18_parcels.area_cm2; Type: COMMENT; Schema: kitchen; Owner: -
--
...
--
-- Name: pg18_parcels pg18_parcels_pkey; Type: CONSTRAINT; Schema: kitchen; Owner: -
--

ALTER TABLE ONLY kitchen.pg18_parcels
    ADD CONSTRAINT pg18_parcels_pkey PRIMARY KEY (id);
...
\unrestrict JNPSzHXajxYVHwHbj39fr9ml3xAUJREn8iHPEC5m4mQezM8Zp4ia5cFbUDDTbJe
