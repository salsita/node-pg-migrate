...
| `includeSchemas`   | `array[string]`                             | Only dump these schemas (`pg_dump --schema`)                                                                                                                                                                          |
| `excludeSchemas`   | `array[string]`                             | Leave these schemas out of the dump (`pg_dump --exclude-schema`)                                                                                                                                                      |
