...
- `domain_name` _[string or object]_ - name of the new domain
...
- `domain_name` _[string or object]_ - name of the the domain to drop
...
- `old_domain_name` _[string or object]_ - old name of the domain
- `new_domain_name` _[string or object]_ - new name of the domain
