...
- `role_name` _[string or object]_ - name of the new role
...
- `old_role_name` _[string or object]_ - old name of the role
- `new_role_name` _[string or object]_ - new name of the role
