...
- `table_name` _[string or object]_ - name of the table where the new trigger will live
- `trigger_name` _[string or object]_ - name of the new trigger
- `trigger_options` _[object]_ - options:
  ...
  - `function` _[string or object]_ - the name of procedure to execute
...
- `table_name` _[string or object]_ - name of the table where the trigger lives
- `trigger_name` _[string or object]_ - name of the trigger to drop
...
- `table_name` _[string or object]_ - name of the table where the trigger lives
- `old_trigger_name` _[string or object]_ - old name of the trigger
- `new_trigger_name` _[string or object]_ - new name of the trigger
