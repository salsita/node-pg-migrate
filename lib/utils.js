...
export const haveBrackets = (string) => {
  const openingBracketPos = string.indexOf('(');
  const closingBracketPos = string.indexOf(')');
  return openingBracketPos >= 0 && closingBracketPos > openingBracketPos;
};
