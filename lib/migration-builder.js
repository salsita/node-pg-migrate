...
import * as materializedViews from "./operations/viewsMaterialized";
...
export default class MigrationBuilder {
  constructor(typeShorthands, db) {
    ...
    this.createView = wrap(views.create);
    this.dropView = wrap(views.drop);
    this.alterView = wrap(views.alter);
    this.alterViewColumn = wrap(views.alterColumn);
    this.renameView = wrap(views.rename);

    this.createMaterializedView = wrap(materializedViews.create);
    this.dropMaterializedView = wrap(materializedViews.drop);
    this.alterMaterializedView = wrap(materializedViews.alter);
    this.renameMaterializedView = wrap(materializedViews.rename);
    this.renameMaterializedViewColumn = wrap(materializedViews.renameColumn);
    this.refreshMaterializedView = wrap(materializedViews.refresh);
